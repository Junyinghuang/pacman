...
entity registers_relay_tb is
end registers_relay_tb;
     
architecture behaviour of registers_relay_tb is
  component registers_relay is
    port (
      ACLK	             : in std_logic;
      ...
      RELAY_A_I              : in  std_logic_vector(C_RB_DATA_WIDTH-1 downto 0);
